...
This is automation + instruction guide I setup to get new members to coding right away on the UMD Robotics @ Maryland team when I was a member. I've reposted it on my own GitHub for posterity.

I would create a base VM image where I ran the `base` Ansible role (save time by doing some configuration ahead-of-time), then new members would download that image to create their virtual machine, where they would just need to run `ram setup` to fully configure their VM.
...
- [R@M dev environment](#rm-dev-environment)
...
- [Development Environment Setup Instructions](#development-environment-setup-instructions)
  - [1. Setup virtual machine software](#1-setup-virtual-machine-software)
    - [VirtualBox](#virtualbox)
      ...
      - [Setting up clipboard sharing (copy and paste between the VM and your host OS)](#setting-up-clipboard-sharing-copy-and-paste-between-the-vm-and-your-host-os)
        ...
        - [Improve screen resolution/quality](#improve-screen-resolutionquality)
  ...
  - [4. Verify that the setup worked](#4-verify-that-the-setup-worked)
    ...
    - [Run the simulation of Qubo](#run-the-simulation-of-qubo)
      - [Teleop](#teleop)
    - [Build the embedded code](#build-the-embedded-code)
- [Issues](#issues)
  ...
  - [Black screen "kernel panic" on VirtualBox](#black-screen-kernel-panic-on-virtualbox)
  - [VirtualBox stuck at boot, never finishes booting](#virtualbox-stuck-at-boot-never-finishes-booting)
  - [VirtualBox I/O Cache error](#virtualbox-io-cache-error)
